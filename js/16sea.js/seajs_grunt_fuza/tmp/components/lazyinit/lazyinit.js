define("MOD_ROOT/lazyinit/lazyinit", [ "jquery" ], function(require, exports, module) {
    var $ = require("jquery");
    ...
    function init() {
        ...
        lazyinit.bindFun($("#example"), function() {
            ...
            require.async([ "MOD_ROOT/example/example", "MOD_ROOT/example/example.css" ], function(example) {
